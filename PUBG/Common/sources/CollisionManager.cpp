...
void CollisionManager::AddCollider(Collider& val)
{
    m_usetColliderBases.emplace(&val);
}

void CollisionManager::RemoveCollider(Collider& val)
{
...
void CollisionManager::FindCollidersWithTag(vector<Collider*>& OutColliders, const COLLISION_TAG tag)
{
...
void CollisionManager::SubscribeCollisionEvent(const COLLISION_TAG perpetrator, const COLLISION_TAG victim)
{
...
void CollisionManager::GetCollideds(vector<Collider*>& OutCollideds, Collider& perpetrator, const COLLISION_TAG victim)
{
