...
//		D3DXMESH_MANAGED | D3DXMESH_32BIT, VERTEX_PNT::FVF, DX::GetDevice(), &m_pMesh);
//	
//	VERTEX_PNT* pV = NULL;
...
//
//
//bool HeightMap::GetHeight(const D3DXVECTOR3 & pos, float * OutHeight)
//{
//	if (pos.x < 0 || pos.z < 0 ||
