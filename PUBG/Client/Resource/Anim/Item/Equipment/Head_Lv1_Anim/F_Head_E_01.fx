...
sampler2D Map__0Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__0>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Head_Lv1_Textures__F_Head_E_01_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Head_Lv1_Textures__F_Head_E_01_D_tgaSampler, vout.TexCoord);
