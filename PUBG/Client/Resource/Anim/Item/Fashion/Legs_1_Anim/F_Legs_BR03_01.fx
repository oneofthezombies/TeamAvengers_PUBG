...
/*** dependency block ***/
texture C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_D_tga; 
texture C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_N_tga; 

sampler2D C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Male_Legs_Textures__M_Legs_BR03_01_D_tgaSampler, vout.TexCoord);
