...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Female_Body_Textures__F_Body_F_01_D_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_umodel_win32_UmodelExport_Assets_Character_Female_Body_Textures__F_Body_F_01_N_tgaSampler, vout.TexCoord0 ) - 1 ;
