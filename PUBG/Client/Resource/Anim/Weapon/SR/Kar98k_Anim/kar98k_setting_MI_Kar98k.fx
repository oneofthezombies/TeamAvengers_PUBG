...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Rifle_Kar98k_Textures__kar98k_01_n_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Rifle_Kar98k_Textures__kar98k_01_d_tgaSampler, vout.TexCoord);
