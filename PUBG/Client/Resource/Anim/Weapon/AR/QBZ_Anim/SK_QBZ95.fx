...
/*** dependency block ***/
texture C__Users_user_Desktop_QBZ_Textures_T_QBZ95_D_tga; 
texture Map__3; 
texture Map__2; 

sampler2D C__Users_user_Desktop_QBZ_Textures_T_QBZ95_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_QBZ_Textures_T_QBZ95_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__3Sampler = sampler_state  // SpecularMap
{ 
   Texture = <Map__3>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__2Sampler = sampler_state  // NormalMap
{ 
   Texture = <Map__2>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(Map__2Sampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_QBZ_Textures_T_QBZ95_D_tgaSampler, vout.TexCoord);
    ...
    if (diffuse.x > 0)
    {
        ...
        float4 specularIntensity = tex2D(Map__3Sampler, vout.TexCoord);
