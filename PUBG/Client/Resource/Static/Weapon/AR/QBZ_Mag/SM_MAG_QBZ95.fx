...
/*** dependency block ***/
texture C__Users_user_Desktop_QBZ_Textures__T_QBZ95_D_tga; 
texture Map__0; 
texture C__Users_user_Desktop_QBZ_Textures__T_QBZ95_N_tga; 

sampler2D C__Users_user_Desktop_QBZ_Textures__T_QBZ95_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_QBZ_Textures__T_QBZ95_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__0Sampler = sampler_state  // SpecularMap
{ 
   Texture = <Map__0>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_QBZ_Textures__T_QBZ95_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_QBZ_Textures__T_QBZ95_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_QBZ_Textures__T_QBZ95_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_QBZ_Textures__T_QBZ95_D_tgaSampler, vout.TexCoord);
