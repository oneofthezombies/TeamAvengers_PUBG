...
/*** dependency block ***/
texture C__Users_user_Desktop_Wall_1_StoneWall_01_Albedo_tga; 
texture C__Users_user_Desktop_Wall_1_Alpha_Mask_Holes_01_N_tga; 

sampler2D C__Users_user_Desktop_Wall_1_StoneWall_01_Albedo_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Wall_1_StoneWall_01_Albedo_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Wall_1_Alpha_Mask_Holes_01_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Wall_1_Alpha_Mask_Holes_01_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Wall_1_Alpha_Mask_Holes_01_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Wall_1_StoneWall_01_Albedo_tgaSampler, vout.TexCoord);
