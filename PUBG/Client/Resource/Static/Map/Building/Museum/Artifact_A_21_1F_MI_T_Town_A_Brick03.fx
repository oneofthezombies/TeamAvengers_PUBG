...
/*** dependency block ***/
texture C__Users_user_Desktop_Buildings_Textures__bricks_13_dif_tga; 
texture C__Users_user_Desktop_Buildings_Textures__bricks_13_nm_tga; 

sampler2D C__Users_user_Desktop_Buildings_Textures__bricks_13_dif_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Buildings_Textures__bricks_13_dif_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Buildings_Textures__bricks_13_nm_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Buildings_Textures__bricks_13_nm_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Buildings_Textures__bricks_13_nm_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Buildings_Textures__bricks_13_dif_tgaSampler, vout.TexCoord);
