...
/*** dependency block ***/
texture C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_D_tga; 
texture C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_N_tga; 

sampler2D C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_floorwood02_D_tgaSampler, vout.TexCoord);
