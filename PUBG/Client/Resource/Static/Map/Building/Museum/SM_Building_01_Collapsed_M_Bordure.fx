...
texture C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Bordure_Atlas_N_tga; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Bordure_Atlas_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Bordure_Atlas_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   ...
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Bordure_Atlas_N_tgaSampler, vout.TexCoord0 ) - 1 ;
