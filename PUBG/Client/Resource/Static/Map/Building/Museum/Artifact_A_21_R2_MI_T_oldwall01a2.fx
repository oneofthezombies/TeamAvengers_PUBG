...
texture C__Users_user_Desktop_Buildings_Textures_Concrete_Wall_01_D_tga; 
texture C__Users_user_Desktop_Buildings_Textures__T_Artifact_A_ceiling02_N_tga; 

sampler2D C__Users_user_Desktop_Buildings_Textures_Concrete_Wall_01_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Buildings_Textures_Concrete_Wall_01_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
float4  PS(VS_OUTPUT vout) : COLOR
{
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Buildings_Textures_Concrete_Wall_01_D_tgaSampler, vout.TexCoord);
