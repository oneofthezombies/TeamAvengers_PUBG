...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_roof_Buildings_Textures__Concrete_White_01_D_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_roof_Buildings_Textures_Masks__Alpha_Mask_H_Lines_01_N_tgaSampler, vout.TexCoord0 ) - 1 ;
