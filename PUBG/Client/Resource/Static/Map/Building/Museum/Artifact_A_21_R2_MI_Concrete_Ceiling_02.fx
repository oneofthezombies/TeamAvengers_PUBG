...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_roof_Buildings_Textures__Concrete_Ceiling_01_D_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_roof_Buildings_Textures__T_Artifact_A_ceiling02_N_tgaSampler, vout.TexCoord0 ) - 1 ;
