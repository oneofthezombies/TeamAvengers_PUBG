...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_OUT_Textures__ABChurch_Conceret_a__D_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_OUT_Textures__ABChurch_Conceret_a__N_tgaSampler, vout.TexCoord0 ) - 1 ;
