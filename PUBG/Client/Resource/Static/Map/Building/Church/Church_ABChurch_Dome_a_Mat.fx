...
texture C__Users_user_Desktop_Resource_Map_Building_Church_Textures__ABChurch_Dome_a_N_tga; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Building_Church_Textures__ABChurch_Dome_a_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_Church_Textures__ABChurch_Dome_a_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Building_Church_Textures__ABChurch_Dome_a_N_tgaSampler, vout.TexCoord).xyz;
