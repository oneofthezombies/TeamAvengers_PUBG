...
/*** dependency block ***/
texture C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_D_tga; 
texture C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_N_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Building_WareHouse_A_Textures__PeeledPaintMetal_D_tgaSampler, vout.TexCoord);
