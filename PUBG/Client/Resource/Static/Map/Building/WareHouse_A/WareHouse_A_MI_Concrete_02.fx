...
/*** dependency block ***/
texture C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__bricks_02_dif_tga; 
texture C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Concrete_01_N_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__bricks_02_dif_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__bricks_02_dif_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Concrete_01_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Concrete_01_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__Concrete_01_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Building_Museum_Textures__bricks_02_dif_tgaSampler, vout.TexCoord);
