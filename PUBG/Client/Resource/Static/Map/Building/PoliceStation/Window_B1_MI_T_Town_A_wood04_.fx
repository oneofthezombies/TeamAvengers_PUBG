...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_Windows_World_Buildings_Textures__T_Town_A_wood04_D_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_Windows_World_Buildings_Textures__T_Town_A_wood04_N_tgaSampler, vout.TexCoord0 ) - 1 ;
