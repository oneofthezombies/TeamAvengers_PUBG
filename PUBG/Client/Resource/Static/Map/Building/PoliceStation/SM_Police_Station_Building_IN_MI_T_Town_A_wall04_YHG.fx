...
texture C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_3ds_Max__ATownHall_Wood_b_N_tga; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_3ds_Max__ATownHall_Wood_b_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_3ds_Max__ATownHall_Wood_b_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   ...
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_3ds_Max__ATownHall_Wood_b_N_tgaSampler, vout.TexCoord0 ) - 1 ;
