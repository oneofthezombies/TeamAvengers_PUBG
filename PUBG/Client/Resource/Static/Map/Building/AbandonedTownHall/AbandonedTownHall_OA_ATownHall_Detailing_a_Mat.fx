...
float4  PS(VS_OUTPUT vout) : COLOR
{
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_OA_Textures__ATownHall_Molding_a_D_tga, vout.TexCoord);
