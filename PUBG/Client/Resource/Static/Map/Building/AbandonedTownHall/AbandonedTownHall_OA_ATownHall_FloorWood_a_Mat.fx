...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_OA_Textures__T_Town_A_wood02_N_tga, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_OA_Textures__T_Town_A_wood02_D_tga, vout.TexCoord);
