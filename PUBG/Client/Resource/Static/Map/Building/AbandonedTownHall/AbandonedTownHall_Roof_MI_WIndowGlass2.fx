...
/*** dependency block ***/
texture C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_Roof_Textures__Glass_Dirty_D_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_Roof_Textures__Glass_Dirty_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_Roof_Textures__Glass_Dirty_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Building_AbandonedTownHall_AbandonedTownHall_Roof_Textures__Glass_Dirty_D_tgaSampler, vout.TexCoord);
