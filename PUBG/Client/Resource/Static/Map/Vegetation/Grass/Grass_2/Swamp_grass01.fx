...
texture C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__Swamp_grass_D_tga; 
texture C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__tex_fieldgrass_weak_n_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__Swamp_grass_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__Swamp_grass_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__tex_fieldgrass_weak_n_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__tex_fieldgrass_weak_n_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__tex_fieldgrass_weak_n_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Vegetation_Grass_Swamp_grass01_Textures__Swamp_grass_D_tgaSampler, vout.TexCoord);
