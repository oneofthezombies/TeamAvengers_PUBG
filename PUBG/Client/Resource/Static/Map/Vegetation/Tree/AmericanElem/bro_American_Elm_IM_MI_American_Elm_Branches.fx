...
texture MI_American_Elm_Branches; 
texture Map__2; 

sampler2D MI_American_Elm_BranchesSampler = sampler_state  // TexCoord0 
{ 
   Texture = <MI_American_Elm_Branches>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
float4  PS(VS_OUTPUT vout) : COLOR
{
    ...
    float4 albedo = tex2D(MI_American_Elm_BranchesSampler, vout.TexCoord);
