...
texture MI_AlaskaCedar_Hero_bro_Branches; 
texture Map__1; 

sampler2D MI_AlaskaCedar_Hero_bro_BranchesSampler = sampler_state  // TexCoord0 
{ 
   Texture = <MI_AlaskaCedar_Hero_bro_Branches>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(Map__1Sampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(MI_AlaskaCedar_Hero_bro_BranchesSampler, vout.TexCoord);
