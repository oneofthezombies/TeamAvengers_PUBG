...
/*** dependency block ***/
texture MI_AlaskaCedar_A_Hero_bro_Leaves; 
texture Map__3; 
texture Map__4; 

sampler2D MI_AlaskaCedar_A_Hero_bro_LeavesSampler = sampler_state  // TexCoord0 
{ 
   Texture = <MI_AlaskaCedar_A_Hero_bro_Leaves>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__3Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__3>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__4Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__4>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(Map__4Sampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(MI_AlaskaCedar_A_Hero_bro_LeavesSampler, vout.TexCoord);
