...
texture C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_tga; 
texture Map__9; 
texture C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_norm_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__9Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__9>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_norm_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_norm_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_Resource_Map_Exterior_BrokenVehicle_BrokenMeshTruck_Textures__TX_flatbed_rusty_norm_tgaSampler, vout.TexCoord0 ) - 1 ;
