...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_Textures__container_front3_bsm_tgaSampler, vout.TexCoord0 ); 
   if(bLight) 
   { 
     float3 bumpNormal =  2 * tex2D( C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_Textures__container_front_nrm_tgaSampler, vout.TexCoord0 ) - 1 ;
