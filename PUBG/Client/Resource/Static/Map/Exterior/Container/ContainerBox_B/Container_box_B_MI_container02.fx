...
texture C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_D_tga; 
texture C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_N_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_D_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_D_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_N_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_N_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_N_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_box_A_3ds_Max__Container_D_tgaSampler, vout.TexCoord);
