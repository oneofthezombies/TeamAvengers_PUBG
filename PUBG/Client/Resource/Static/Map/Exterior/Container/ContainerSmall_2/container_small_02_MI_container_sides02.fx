...
texture C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_02_Textures__container_sides0_bsm_tga; 
texture C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides_nrm_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_02_Textures__container_sides0_bsm_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_02_Textures__container_sides0_bsm_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides_nrm_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides_nrm_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{
    float3 tangentNormal = tex2D(C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides_nrm_tgaSampler, vout.TexCoord).xyz;
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_02_Textures__container_sides0_bsm_tgaSampler, vout.TexCoord);
