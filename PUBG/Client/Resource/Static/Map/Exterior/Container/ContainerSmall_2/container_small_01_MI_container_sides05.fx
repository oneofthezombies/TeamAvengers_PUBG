...
texture C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides3_bsm_tga; 
texture C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides_nrm_tga; 

sampler2D C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides3_bsm_tgaSampler = sampler_state  // TexCoord0 
{ 
   Texture = <C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides3_bsm_tga>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
float4  PS(VS_OUTPUT vout) : COLOR
{
    ...
    float4 albedo = tex2D(C__Users_user_Desktop_Resource_Map_Exterior_Container_Container_small_01_3ds_Max__container_sides3_bsm_tgaSampler, vout.TexCoord);
