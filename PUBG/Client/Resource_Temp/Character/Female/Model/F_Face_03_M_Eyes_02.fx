...
float  SpecularPower = 52.000000f; 
float4 SpecularColor = { 0.069300f, 0.069300f, 0.069300f, 1.000000f }; 
float4 EmissiveColor = { 0.000000f, 0.000000f, 0.000000f, 1.000000f }; 

texture Map__12; 

sampler2D Map__12Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__12>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( Map__12Sampler, vout.TexCoord0 ); 
